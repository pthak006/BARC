...
INDUCTION_SAMPLE_EXEC_RESULTS_DIRS_AND_SAMPLE_SIZE = [
    ("results", 256),  # e.g. "results" is the folder containing your single .jsonl, 128 samples per problem
...
def main(metrics_csv_path, output_csv_path, results_dir=None): # Pass paths as arguments
    ...
    if results_dir:
        ...
        INDUCTION_SAMPLE_EXEC_RESULTS_DIRS_AND_SAMPLE_SIZE = [(results_dir, 256)]
